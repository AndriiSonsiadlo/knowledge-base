...
A watchdog that reboots the system silently has told you nothing. `RCC_CSR` holds why the last reset happened, and the flags are **sticky across resets** — they accumulate until software clears them (RM0383 §6.3.18).
