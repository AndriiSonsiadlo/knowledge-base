          ...
          <div className="py-16 md:py-20 flex flex-col items-center justify-center">
            ...
            >
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                <p className="text-lg md:text-xl font-semibold text-[var(--ifm-color-text-primary)]">
                  A personal repository for mastering computer science and
                  software development.
                </p>

                <p className="text-base md:text-lg text-[var(--ifm-color-text-secondary)] leading-relaxed">
