...
export default function Home(): ReactNode {
    ...
    return (
        ...
        >
            <div className={clsx(styles.heroGradient, 'w-full relative overflow-hidden')}>
                ...
                <main className={clsx('container mx-auto px-4 relative z-10')}>
                    ...
                    <div className="py-16 md:py-20 flex flex-col items-center justify-center">
                        <div
                            className={clsx(styles.glassCard, 'p-8 md:p-16 rounded-3xl text-center w-full md:w-3/4 lg:w-2/3')}>
                            <Heading as="h1"
                                     className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-200 via-blue-200 to-purple-200">
                                {siteConfig.title}
                            </Heading>
                            ...
                            <div className="space-y-6 max-w-2xl mx-auto">
                                ...
                                <p className="text-base md:text-lg text-slate-300 leading-relaxed">
                                    ...
                                    learning. Each section contains detailed explanations, practical
                                    examples, and the insights I’ve gathered along the way.
                                </p>
