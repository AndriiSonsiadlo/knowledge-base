    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Navigation */}
                <nav className="backdrop-blur-md bg-white/5 border border-white/10 rounded-full px-6 py-3 inline-flex items-center gap-2 mt-6 hover:bg-white/10 transition-all duration-300">
                    <BookOpen className="w-5 h-5 text-purple-400" />
                    <span className="text-white font-semibold">Knowledge Base</span>
                </nav>

                {/* Hero Section */}
                <div className="min-h-[calc(100vh-200px)] flex flex-col justify-center gap-12 py-20">
                    {/* Main content */}
                    <div className="space-y-6">
                        ...
                        <p className="text-lg sm:text-xl text-slate-300 max-w-2xl leading-relaxed">
                            A modern knowledge base built with Docusaurus. Organize your thoughts, save structured information, and access everything with powerful search.
                        </p>

                        {/* CTA Buttons */}
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button className="group relative px-8 py-3 font-semibold overflow-hidden rounded-lg transition-all duration-300">
                                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-blue-500 group-hover:scale-105 transition-transform duration-300"></div>
                  ...
                  <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                            ...
                            <button className="group px-8 py-3 font-semibold rounded-lg backdrop-blur-md bg-white/10 border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 text-white">
                                Explore Docs
                            </button>
                        </div>
                    </div>
                        ...
                        {features.map((feature, idx) => (
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="p-3 rounded-lg bg-gradient-to-br from-purple-500/20 to-blue-500/20 group-hover:from-purple-500/40 group-hover:to-blue-500/40 transition-colors">
                    ...
                    <div className="mt-12">
                        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8">
                            <div className="flex items-center gap-3 bg-white/10 border border-white/20 rounded-xl px-4 py-3 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="py-16 grid grid-cols-3 gap-8 text-center">
                    {[
                        ...
                        <div key={idx} className="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all">
